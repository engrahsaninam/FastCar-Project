								...
								<div className="swiper-wrapper">
									<SwiperSlide>
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/car">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-1.png" alt="Fast4Car" />
												</Link>
											</div>
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												...
												<div className="card-title pb-1"><Link className="heading-6 neutral-1000" href="/car">Audi A3 1.6 TDI S line</Link></div>
										...
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/car">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-2.png" alt="Fast4Car" />
												</Link>
											</div>
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												<div className="card-rating position-relative start-0 top-0">
												...
												<div className="card-title pb-1"><Link className="heading-6 neutral-1000" href="/car">BMW 320d xDrive M</Link></div>
												<div className="card-program">
													<div className="card-facitlities border-0 pb-3">
														<p className="card-miles text-md-medium">72.491km</p>
														<p className="card-gear text-md-medium">Automatic</p>
										...
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/car">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-3.png" alt="Fast4Car" />
												</Link>
											</div>
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												<div className="card-rating position-relative start-0 top-0">
												...
												<div className="card-title pb-1"><Link className="heading-6 neutral-1000" href="/car">Mercedes-Benz C220d</Link></div>
												<div className="card-program">
													<div className="card-facitlities border-0 pb-3">
														<p className="card-miles text-md-medium">72.491km</p>
														<p className="card-gear text-md-medium">Automatic</p>
									...
									<SwiperSlide>
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/car">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-4.png" alt="Fast4Car" />
												</Link>
											</div>
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												<div className="card-rating position-relative start-0 top-0">
												...
												<div className="card-title pb-1"><Link className="heading-6 neutral-1000" href="/car">Volkswagen Golf GTD</Link></div>
												<div className="card-program">
													<div className="card-facitlities border-0 pb-3">
														<p className="card-miles text-md-medium">72.491km</p>
														<p className="card-gear text-md-medium">Automatic</p>
										...
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/car">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-5.png" alt="Fast4Car" />
												</Link>
											</div>
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												<div className="card-rating position-relative start-0 top-0">
												...
												<div className="card-title pb-1"><Link className="heading-6 neutral-1000" href="/car">Volvo S60 D4 R-Design</Link></div>
												<div className="card-program">
													<div className="card-facitlities border-0 pb-3">
														<p className="card-miles text-md-medium">72.491km</p>
														<p className="card-gear text-md-medium">Automatic</p>
										...
										<div className="card-journey-small card-journey-small-listing-3 background-0 d-flex flex-md-row flex-column align-items-center mw-100 position-relative">
											<div className="card-image w-100">
												<Link href="/car">
													<img src="/assets/imgs/cars-listing/cars-listing-3/car-6.png" alt="Fast4Car" />
												</Link>
											</div>
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												<div className="card-rating position-relative start-0 top-0">
												...
												<div className="card-title pb-1"><Link className="heading-6 neutral-1000" href="/car">Jaguar XE 2.0d R-Sport</Link></div>
												<div className="card-program">
													<div className="card-facitlities border-0 pb-3">
														<p className="card-miles text-md-medium">72.491km</p>
														<p className="card-gear text-md-medium">Automatic</p>
