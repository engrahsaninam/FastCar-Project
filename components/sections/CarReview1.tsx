						...
						<div className="row">
							<div className="col-lg-7">
								<div className="card-grid-video wow fadeIn">
									<div className="card-image"><a className="btn btn-play popup-youtube" onClick={() => setOpen(true)}> </a><img className="mr-10" src="/assets/imgs/car-review/car-review-1/img-video-1.png" alt="Fast4Car" /></div>
							...
							<div className="col-lg-5">
								<div className="list-videos-small">
									<div className="item-video-small wow fadeIn" data-wow-delay="0.1s">
										<div className="item-image"><a className="btn-play-sm popup-youtube" onClick={() => setOpen(true)}> </a><img className="mr-10" src="/assets/imgs/car-review/car-review-1/img-video-2.png" alt="Fast4Car" />
										</div>
										<div className="item-info">
											<Link className="heading-6" href="/car">Best Midsize 3-row SUVs 2024</Link>
											<p className="text-md-medium neutral-500">18 August 2024</p>
										</div>
									</div>
									<div className="item-video-small wow fadeIn" data-wow-delay="0.2s">
										<div className="item-image"><a className="btn-play-sm popup-youtube" onClick={() => setOpen(true)}> </a><img className="mr-10" src="/assets/imgs/car-review/car-review-1/img-video-3.png" alt="Fast4Car" />
										</div>
										<div className="item-info">
											<Link className="heading-6" href="/car">5 Best Luxury sport coupes
												2024</Link>
											<p className="text-md-medium neutral-500">18 August 2024</p>
										</div>
									</div>
									<div className="item-video-small wow fadeIn" data-wow-delay="0.3s">
										<div className="item-image"><a className="btn-play-sm popup-youtube" onClick={() => setOpen(true)}> </a><img className="mr-10" src="/assets/imgs/car-review/car-review-1/img-video-4.png" alt="Fast4Car" />
										</div>
										<div className="item-info">
											<Link className="heading-6" href="/car">Best Small hatchbacks 2024 and
												2025</Link>
											<p className="text-md-medium neutral-500">18 August 2024</p>
										</div>
									</div>
