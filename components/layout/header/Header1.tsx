...
<Flex className="text-header-info" align="center" gap={4}>
  ...
  >
    ...
    <Text display={{ base: 'none', lg: 'block' }} fontWeight="bold" fontSize="lg">‪‪+34 618 00 73 25</Text>
  </ChakraLink>
  
  <ChakraLink 
    as={Link} 
    className="email-head" 
    href="mailto:sale@Fast4Car.com" 
    color="white"
    fontWeight="bold"
    fontSize="lg" 
    display="flex"
													...
													<div className="row">
														<div className="col-lg-6">
															...
															<ul className="sub-menu">
																<li><Link href="/cars">Cars List v1</Link></li>
														...
														<div className="col-lg-6">
															...
															<ul className="sub-menu">
																<li><Link href="/car">Car Details v1</Link></li>
