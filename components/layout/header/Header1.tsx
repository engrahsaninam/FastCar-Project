					...
					<div className="container-fluid">
						<Flex className="text-header-info" align="center" gap={4}>
							...
							>
								...
								<Text display={{ base: 'none', lg: 'block' }} fontWeight="400" fontSize="sm">‪‪+34 618 00 73 25</Text>
							</ChakraLink>
							...
							>
								...
								<Text display={{ base: 'none', lg: 'block' }} fontWeight="400" fontSize="sm">sale@Fast4Car.com</Text>
							</ChakraLink>
						</Flex>
