  ...
  return (
    <>
      ...
      <div className="md:hidden relative w-full" style={
        ...
        >
          {/* Single gradient that starts after the heading */}
          ...
          <div className="relative top-14 pt-6 px-4">
            <h1 className="text-3xl mt-20 font-bold text-white leading-tight">
      ...
      <div className="hidden md:block  w-full relative">
        ...
        >
          ...
          <div
            className="absolute bottom-0 w-full " // Full screen height
              ...
              <div className="flex flex-row space-x-12 h-full">
                ...
                <div className="space-y-8 text-white flex-1">
                  <div>
                    ...
                    <p className="text-[#ffffff] max-w-lg leading-relaxed">
