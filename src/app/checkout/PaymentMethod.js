  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-6 md:space-y-8 p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
            ...
            >
              ...
              <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                ...
                <span className="text-sm md:text-base">Yes, I'm interested</span>
              </div>
            </button>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm md:text-base">No, I want to pay by bank transfer</span>
              </div>
            </button>
          </div>
        </div>
      ...
      <div id="car-condition">
        ...
        <h2 className="text-lg md:text-xl font-semibold text-gray-700 mb-3">Car condition check</h2>
        <div className="bg-white rounded-lg p-4">
          <div className="flex items-center gap-3">
            <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center shrink-0">
              <Check className="w-4 h-4 text-gray-400" />
            </div>
            <span className="text-sm md:text-base text-gray-600">CarAudit™ vehicle inspection</span>
          </div>
        </div>
      </div>
      ...
      <div id="delivery">
        ...
        <h2 className="text-lg md:text-xl font-semibold text-gray-700 mb-3">Delivery</h2>
        <div className="space-y-2">
          ...
          <div className="bg-white rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm md:text-base text-gray-600">Delivery</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm md:text-base text-gray-600">Additional Services</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm md:text-base text-gray-600">Fast Guard</span>
      ...
      <div id="payment">
        ...
        <h2 className="text-lg md:text-xl font-semibold text-gray-700 mb-3">Payment</h2>
        <div className="bg-white rounded-lg p-4">
          <div className="flex items-center gap-3">
            <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center shrink-0">
              <Check className="w-4 h-4 text-gray-400" />
            </div>
            <span className="text-sm md:text-base text-gray-600">Payment</span>
          </div>
        </div>
      </div>
    </div>
